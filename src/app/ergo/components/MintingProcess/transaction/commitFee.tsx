...
export default function CommitFee(){
    ...
    const handleClick = async () => {
        ...
        if (parseFloat(transactionFee) > 0) {
            txOperatorFee = BigInt(parseFloat(transactionFee)*NANOERG_TO_ERG);
            minerFee = BigInt(parseFloat(transactionFee)*NANOERG_TO_ERG);
        }
        ...
        const inputs = isErgoPay
            ...
            const nameToRegisterBytes = utf8.decode(ergoname);
    ...
    return (
        <div className="flex flex-col items-center justify-center">
            ...
            <div className="card card-compact w-1/2 bg-grey shadow-l my-1">
                <div className="card-body">
                    <div className="flex items-center justify-between text-black">
                        ...
                        <div className="flex-none">
                            <p>{parseFloat(transactionFee) * 2} ERG</p>
                        </div>
                    </div>
                    <div className="flex items-center justify-between text-black">
                        <div className="flex-none">
                    ...
                    <div className="flex items-center justify-between text-black">
                        ...
                        <div className="flex-none">
                            <p>{parseFloat(transactionFee) * 4} ERG</p>
                        </div>
                    </div>
                </div>
            </div>
            <button
                ...
                onClick={handleClick}>Open Wallet</button>
        </div>
    )
}
