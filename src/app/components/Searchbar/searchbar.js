...
function Searchbar() {
    ...
    const handleInputChange = (event) => {
        ...
        setTier(getTierFromLength(event.target.value));
    };
    ...
    <div className="flex flex-col items-center justify-center bg-grey text-black h-[80vh]">
        ...
        <div className='flex flex-col items-center mb-4'>
            <div className="w-full flex flex-col p-5">
                ...
                <h3 className="text-sm text-center text-slate-500 ">Your identity across web3, one name for all your
                    crypto
                    addresses, and your decentralised website.</h3>
            </div>
            <div className="flex items-center">
                <input type="text" placeholder="Search for name" value={searchInput} onChange={handleInputChange}
                    className="p-2 border-gray-300 rounded-l-xl bg-gray-200 focus:outline-none text-slate-500" />
                <button className="flex items-center bg-customOrange text-white p-2 rounded-r-xl"
                    onClick={handleSearchClick} disabled={searchInput.trim()==='' }>
